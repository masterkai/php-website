/*
	Sly JS Plugin
	Site	: https://github.com/darsain/sly
...
;(function ($, w, undefined) {
	...
	function Sly(frame, options, callbackMap) {
		...
		function activatePageHandler() {
			/*jshint validthis:true */
			// Accept only events from direct components bar children.
	...
	Sly.defaults = {
		...
		// Pagesbar
		pagesBar:       null, // Selector or DOM element for components bar container.
		...
		// Automated cycling
		cycleBy:       null, // Enable automatic cycling by 'items' or 'components'.
		...
		keyboardNavBy: null,    // Enable keyboard navigation by 'items' or 'components'.

		// Classes
		draggedClass:  'dragged',  // Class for dragged elements (like SLIDEE or scrollbar handle).
		activeClass:   'active',   // Class for active items and components.
